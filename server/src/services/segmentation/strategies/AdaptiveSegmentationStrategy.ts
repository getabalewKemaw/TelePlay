...
export const createAdaptiveSegmentationStrategy = (): ISegmentationStrategy => {
  const getName = (): string => 'adaptive';
...
export type AdaptiveSegmentationStrategy = ReturnType<typeof createAdaptiveSegmentationStrategy>;
