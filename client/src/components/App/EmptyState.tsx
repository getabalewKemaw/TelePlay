...
export function EmptyState() {
  return (
    <div className="h-full flex flex-col items-center justify-center text-center space-y-8 animate-in fade-in zoom-in-95 duration-1000">
      <div className="w-32 h-32 bg-white/50  rounded-[2.5rem] rotate-12 flex items-center justify-center text-coffee-400 shadow-2xl">
      ...
      <div className="space-y-3 max-w-sm">
        ...
        <p className="text-sm text-coffee-400 font-bold uppercase tracking-wider leading-relaxed">
          Select a terminal source from the left inventory to initiate primary decode sequence and In Order To play as well.
        </p>
      </div>
    </div>
  )
